 ...
 * @property {number|string} [padding] - Custom axis label padding.  CSS units permitted
...
export class Chart extends EventTarget {
    ...
    _drawAxis(orientation, el, options) {
        ...
        if (options.padding != null) {
            el.style.setProperty('--axis-padding', typeof options.padding === 'number' ?
                `${options.padding}px` : options.padding);
        } else {
        ...
        if (options.rotate != null) {
            ...
            el.style.removeProperty('--axis-angle');
        }
